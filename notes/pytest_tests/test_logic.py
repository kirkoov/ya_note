...
def test_user_can_create_note(author_client, author, form_data):
    ...
    # но если хоть одна из этих проверок провалится, весь тест можно признать
    # провалившимся, а последующие невыполненные проверки не внесли бы в отчёт
    # о тесте ничего принципиально важного.
